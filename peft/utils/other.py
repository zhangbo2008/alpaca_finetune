...
def prepare_model_for_int8_training(
    ...
    for name, param in model.named_parameters():
        ...
        if loaded_in_8bit:
            ...
            if param.ndim == 1 and any(layer_norm_name in name for layer_norm_name in layer_norm_names):#对于layer_norm里面的参数, 如果是1维的那么我们就把他变成float32.
    ...
    if loaded_in_8bit and use_gradient_checkpointing:
        ...
        model.gradient_checkpointing_enable()#节约显存.
